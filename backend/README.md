...
## Project Structure
    ...
    ├── rutgers_course_edit_41012  # Django project configurations
...
1. Clone this repo and `cd rutgers_course_edit_41012`
...
2. Clone this repo and `cd rutgers_course_edit_41012`
